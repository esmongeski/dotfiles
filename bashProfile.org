...
Powerline - stolen from https://medium.com/earlybyte/powerline-for-bash-6d3dd004f6fc, follow setup instructions there.
#+begin_src bash
...
#+end_src
Then check for mac setup
#+begin_src bash
elif [ -f $HOME/Library/Python/3.9/lib/python/site-packages/powerline/bindings/bash/powerline.sh ]; then
  export LC_ALL=en_US.UTF-8
  export PATH="$PATH:$HOME/Libary/Python/3.9/bin"
