...
If you haven't already noticed, this is an org file, not a bash file. I use a couple scripts to [[./bash_profile.bash][complie this to bash]] and then [[./bash_profile.bash][execute it.]]
* COLORS
