...
#+begin_src bash
  ...
  function _update_ps1() {
      PS1="$($GOPATH/bin/powerline-go -error $? -jobs $(jobs -p | wc -l) -shell bash -modules cwd,git,exit -cwd-max-dir-size 2 -truncate-segment-width 5 -path-aliases=$EXTRA_POWERLINE_DIR_ALIASES  $EXTRA_POWERLINE_OPTIONS | sed -E 's|es/||; s/([a-zA-Z0-9_./-]{10})[a-zA-Z0-9_./-]+/\1…/')"
