...
#+BEGIN_SRC emacs-lisp
  (custom-set-variables
   '(org-agenda-files
     (quote
      (
       "~/Dropbox/org/recurring.org"
       "~/Dropbox/org/homeProjects.org"
       "~/Dropbox/org/personalProjects.org"
       "~/Dropbox/org/funThings.org"
       "~/Dropbox/org/workStuff.org"
       "~/Dropbox/org/archive.org"
       (find-lisp-find-files "~/Dropbox/org/roam" "\.org$"))))
