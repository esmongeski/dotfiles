...
#+BEGIN_SRC emacs-lisp
    ...
    ;;)
#+END_SRC
Packages, which I guess says which packages are installed? Not actually sure what package-selected-packages is.
#+BEGIN_SRC emacs-lisp
   '(package-selected-packages
     (quote
      (org-bullets helm-org monitor dash powerline-evil ## org-link-minor-mode org-mobile-sync evil))))
#+END_SRC
