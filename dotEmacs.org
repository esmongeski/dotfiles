...
* Save on kill daemon
I've been running emacs as a daemon so that it doesn't need to compile this file every time. That appears to cause some weirdness with open unsaved
buffers.

[[https://www.emacswiki.org/emacs/EmacsAsDaemon][This function]] allows a prompt before killing emacs. It is invoked by =emacsclient -e '(client-save-kill-emacs)'=
#+begin_src emacs-lisp
